...
1. **Keep it concise**: AGENTS.md should be focused and relevant
2. **Project structure**: Document your project's organization
3. **Code standards**: Define coding conventions and style guides
4. **Workflow**: Explain your team's development workflow
5. **Commit to Git**: Share rules with your team by committing AGENTS.md
6. **Personal rules**: Use global `~/.config/opencode/AGENTS.md` for personal preferences
