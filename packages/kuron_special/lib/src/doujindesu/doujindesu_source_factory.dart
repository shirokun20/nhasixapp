...
class DoujindesuSourceFactory implements SourceFactory {
  ...
  @override
  String get sourceId => 'doujindesuv2';

  @override
  ContentSource create(Map<String, dynamic> config) {
    // Keep parity with existing Cloudflare-protected factory behavior.
    try {
      ...
      _logger.w('Failed to attach NativeAdapter for Doujindesu: $e');
    }

    final interceptingDio = _DoujindesuDioInterceptor(
      baseDio: _dio,
...
class _DoujindesuDioInterceptor with DioMixin implements Dio {
  _DoujindesuDioInterceptor({
