...
class AnalyticsService {
  ...
  Future<Map<String, dynamic>> getAnalyticsSummary() async {
    ...
    try {
      ...
      final events =
          (jsonDecode(analyticsData) as List).cast<Map<String, dynamic>>();
      ...
      final screenViews =
          events.where((e) => e['eventType'] == 'screen_view').length;
      final actions =
          events.where((e) => e['eventType'] == 'user_action').length;
  ...
  Future<void> _trackEvent(AnalyticsEvent event) async {
    try {
      ...
      if (existingData != null) {
        events =
            (jsonDecode(existingData) as List).cast<Map<String, dynamic>>();
      }
...
class AnalyticsEvent {
  ...
  factory AnalyticsEvent.sessionEnd(Duration sessionDuration) =>
      AnalyticsEvent._(
        eventType: 'app_lifecycle',
  ...
  // User actions
  factory AnalyticsEvent.userAction(String action,
          {Map<String, dynamic>? parameters}) =>
      AnalyticsEvent._(
  ...
  factory AnalyticsEvent.performance(String operation, Duration duration,
  ...
  // Error tracking
  factory AnalyticsEvent.error(String errorType, String errorMessage,
  ...
  // Feature usage
  factory AnalyticsEvent.featureUsage(String feature,
  ...
  // Reading sessions
  factory AnalyticsEvent.readingSession(
          String contentId, Duration readingTime, int pagesRead) =>
      AnalyticsEvent._(
  ...
  // Content interaction
  factory AnalyticsEvent.contentInteraction(
          String interaction, String contentId,
          {Map<String, dynamic>? metadata}) =>
      AnalyticsEvent._(
