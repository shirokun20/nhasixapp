          ...
          createHttpClient: () {
            ...
            client.connectionFactory =
              ...
              try {
                ...
                logger.e('DoH resolution failed for ${uri.host}', error: e);
                // No system DNS fallback: propagate the error so the caller
                // gets a clear failure rather than silently using censored DNS.
                rethrow;
              }
            };
