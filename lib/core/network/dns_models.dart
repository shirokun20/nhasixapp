...
enum DnsProvider {
  ...
  /// AdGuard excluded because 94.140.14.14/dns-query returns HTTP 400 for
  /// JSON API (only supports wire-format RFC 8484 via IP, not DoH-JSON).
  /// Order: Cloudflare → Google (most reliable, lowest latency first).
