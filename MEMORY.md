...
| 2026-07-12 | Claude Code | Fixing from commit hash 71ac8d81db091baf13d1bc3dd7688f8e5ff3f665 to 96c6b0218c9304fba65aa39649e8ab1196f0b936 about fixing login nhentai and crotpedia | Done | Fixed nhentai login (cookie `ipb_member_id`/`ipb_pass_hash`) and crotpedia login (cookie `PHPSESSID`) by adding missing `Cookie:` prefix in `Dio` headers. Verified with real API calls. |
